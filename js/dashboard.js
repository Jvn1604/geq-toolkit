...
(function () {
  ...
  function shortLabel(c) {
    return c
      .replace("Financial Knowledge and Concepts", "Knowledge")
      .replace("Financial Decision Making", "Decisions")
      .replace("Learning Outcomes and Behavioral Awareness", "Outcomes")
